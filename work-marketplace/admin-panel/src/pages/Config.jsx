    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Admin-editable business rules & platform configuration</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSave}>
          <div className="form-group">
            ...
            <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>
              Currently: {config?.commissionPercent}% — Workers receive {100 - (config?.commissionPercent || 0)}% of the gross job amount
            </span>
          </div>

          <div className="form-group">
            <label>Auto-Release Payment Window (hours after worker marks complete)</label>
            <input
            ...
            />
            <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>
              If poster does not approve or dispute within this window, payment auto-releases to worker
            </span>
          </div>
          ...
          <div className="form-group">
            <label>Max Photos per Job Post</label>
            <input
          ...
          <div className="form-group">
            <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer' }}>
              <input
                ...
                style={{ width: 'auto' }}
              />
              Registrations Open (uncheck to temporarily pause new sign-ups)
            </label>
          </div>
